...
# Code from https://github.com/manzilzaheer/DeepSets 
# D5 extended from this -- Deeper Deep Sets with 5 equivariant layers
...
class D(nn.Module):
  ...
  def __init__(self, d_dim, x_dim=3, pool = 'mean', out_dim=2):
